...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6369677eb78508d2bdfc4a9a2a7399c0) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "OCaml bindings to the UDUNITS-2 library";
          description = None;
          categories = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\176\196\238\181\152\236Q\206\173\199D7\242f\024*";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
