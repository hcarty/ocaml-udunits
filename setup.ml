...
(* OASIS_START *)
(* DO NOT EDIT (digest: df3ca0009493ac7f615d068291b786eb) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/hcarty/ocaml-udunits";
          synopsis = "Bindings to the UDUNITS-2 library";
          description =
            Some
              "This library provides access to the UDUNITS-2 unit conversion\nlibrary (http://www.unidata.ucar.edu/software/udunits/).";
          categories = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/hcarty/ocaml-udunits.git";
                      src_repo_browser =
                        Some "https://github.com/hcarty/ocaml-udunits";
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\242\193\001\"_\157r\2165[eD\197\216\192\011";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
